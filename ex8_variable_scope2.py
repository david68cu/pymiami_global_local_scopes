...
In example 7 we saw thsi example and how it worked

  ..at compilation time Python sees print(b) . So Python decides that b is local at compilation time
...
Read Lucioano Fluent Python Chapter 7 page 96 to solve this issue and see Closures , global , nonlocal and free vars

Ok but how to fix it ? Using the keyword global inside the function as shown in f3() below
"""
...
27           0 LOAD_GLOBAL              0 (print)
 ...
 28           8 LOAD_GLOBAL              0 (print)
             10 LOAD_FAST                1 (b)
             12 CALL_FUNCTION            1
             14 POP_TOP

 29          16 LOAD_CONST               1 (9)
             18 STORE_FAST               1 (b)
             20 LOAD_CONST               0 (None)
             22 RETURN_VALUE
3
6
 ...
 68           8 LOAD_GLOBAL              0 (print)
             10 LOAD_GLOBAL              1 (b)
             12 CALL_FUNCTION            1
             14 POP_TOP

 69          16 LOAD_CONST               1 (9)
             18 STORE_GLOBAL             1 (b)
             20 LOAD_CONST               0 (None)
             22 RETURN_VALUE
